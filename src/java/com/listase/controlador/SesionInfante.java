...
public class SesionInfante implements Serializable {
    ...
    private void inicializar()
    {
        ...
        //LLenado de la bds
        listaInfantes.adicionarNodo(new Infante("Carlitos",(short)0,(short) 1, (byte)2));
    ...
    public void setInfante(Infante infante) {
     ...
     public void hombre()
    {
        infante.setGenero((short)(listaInfantes.hombre()+1));
        if(genero.compareTo("1")==0)
        {
     ...
     public void mujer()
    {
        infante.setGenero((short)(listaInfantes.mujer()+1));
        if(genero.compareTo("1")==1)
        {
