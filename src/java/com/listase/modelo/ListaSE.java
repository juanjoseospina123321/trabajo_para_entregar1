...
public class ListaSE implements Serializable{
    ...
    private Infante genero;

    public ListaSE(Infante infante, Infante genero) {
    ...
    public Infante getGenero() {
        return genero;
    }

    public void setGenero(Infante genero) {
        this.genero = genero;
    }
